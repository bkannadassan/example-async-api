...
private:
  ...
  private:
    std::shared_ptr<PWApiClient> m_client;
    oatpp::String m_message;
    v_int32 m_code;
  public:
    
    SendDtoCoroutine(const std::shared_ptr<PWApiClient> client,
  ...
  public:
    ...
    SendCoroutine(const std::shared_ptr<PWApiClient> client) : m_client(client) {}
...
public:
  ...
  void static runExample(const std::shared_ptr<PWApiClient>& client);
