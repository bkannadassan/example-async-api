...
#include "PWClientAsync.hpp"
#include "PWClientApiModels.hpp"
...
void run(){
  ...
  /* PWClient uses DemoRequestExecutor and json::mapping::ObjectMapper */
  /* ObjectMapper passed here is used for serialization of outgoing DTOs */
  auto client = PWApiClient::createShared(requestExecutor, objectMapper);
